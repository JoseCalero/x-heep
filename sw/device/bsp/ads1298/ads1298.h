...
/* ADS1298 modes */
#define VCONF_ADS1298_MODE_EEG  0
#define VCONF_ADS1298_MODE_ECG  1
...
#define ADS_SS_PIN     7
#define ADS_INT_PIN    9
#define ADS_INT_INTR  GPIO_INTR_9
#define ADS_PIN_Reset  1 //Y8 in pynq-z2
#define ADS_PIN_Start  2 //W8 in pynq-z2
 ...
 * 
 * @param  intf_ptr : SPI interface pointer
 * 
 ...
 */
__attribute__((optimize("O0"))) extern void ADS1298_interrupt_handler(void);

/**
 * @brief Function to handle the ADS1298 thread
 * 
 * @param  intf_ptr : SPI interface pointer
 * @param  data_ecg : pointer to the ECG data 
 * 
 * @return 0 if successful, error code otherwise 
 */
extern int ADS1298_thread_func(void * intf_ptr, uint8_t *data_ecg);


extern void ads1298_delay_us(uint32_t period);
